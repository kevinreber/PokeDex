        ...
        <>
            <div className="modal-overlay">
                <div className="modal-cycle-container">
                    <div className="modal-button modal-prev">
                        <span> &#60; </span>
                    </div>
                </div>
                <div classNames="modal-card">
                    <svg onClick={props.onHide} className="modal-close" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                ...
                <div className="modal-cycle-container">
                    <div className="modal-button modal-next">
                        <span> &#62; </span>
                    </div>
                </div>
            </div>
